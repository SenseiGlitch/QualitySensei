...
export function Terminal({ className }: TerminalProps) {
  ...
  return (
    <div className={cn("max-w-3xl mx-auto rounded-lg overflow-hidden shadow-2xl shadow-purple-500/20 fade-in-up delay-400", className)}>
      ...
      <div className="bg-gray-900 dark:bg-black p-4 font-mono text-sm terminal-gradient">
        <div className="text-gray-300 space-y-2">
          ...
          <div className="terminal-line">
            ...
            <span className={`cursor border-r-2 h-5 ml-0.5 ${isTyping ? 'animate-blink' : ''}`}></span>
          </div>
        </div>
      </div>
    </div>
