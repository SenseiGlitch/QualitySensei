      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              The high-performance educational platform for software testing, built with Astro and React 19.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-500 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9.101 23.691v-7.98h-2.679v-3.667h2.679v-2.518c0-2.4 1.678-4.705 4.989-4.705 1.402 0 2.441.106 2.441.106l-.08 3.407s-1.058-.01-2.215-.01c-1.25 0-1.449.569-1.449 1.51v2.21h3.747l-.162 3.667h-3.585v7.98h-3.687z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <Input 
                ...
                className="px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
              />
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 dark:text-gray-400 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} QualitySensei. All rights reserved.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
              Terms of Service
